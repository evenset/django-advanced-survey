...
export const reducer = (state: SurveyState, action: any) => {
    ...
    switch (action.type) {
        ...
        case 'addQuestion':
            current_page.push({ id: makeID(12), list_order: current_page.length, field: FieldType.LineEdit, is_visible: ['always'], is_required: ['always'], question: '', description: '', option: {}})
